...
namespace Synergix.ADCE.Lite
{
    ...
    {
        public List<string> AddParameter { get; }
        ...
        public Arguments(string[] args)
        {
            ...
            foreach (string input in args)
            {
                ...
                {
                    count = 0;
                    if (parameter.StartsWith("readonly") || parameter.StartsWith("update") || parameter == "domainPriority" || parameter == "dnsonly" || parameter == "network" || parameter == "pridns" || parameter == "altdns" || parameter == "terdns")
                    {
        ...
        public bool IsArgumentSpecifed(string arg)
        {
